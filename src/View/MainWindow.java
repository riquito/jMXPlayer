...
public class MainWindow extends javax.swing.JFrame implements ActionListener {
    ...
    private void on_trackWindowToggleBtn_clicked(String btnType){
        ...
        if (btnType.compareTo("play")==0) {
            ...
            /*for(PartitureWindow win: partitureWindows) {
                ...
                win.resetPrefetching();
                win.refreshPartitureImage();
            }
            */
        }
    ...
    public void loadMX(String path){
        ...
        if (this.player!=null && this.player.getState()!=this.player.Started) this.player.stop();
    ...
    public void loadMusic(){
        try {
            ...
            for(int i=0;i<this.audioCombo.getItemCount();i++){
                newPlayer=Manager.createPlayer(new File(this.MX.audioClipDict.get(this.audioCombo.getItemAt(i)).getFileAudioPath()).toURI().toURL());
                newPlayer.addControllerListener(new ControllerListener(){
                    public synchronized void controllerUpdate(ControllerEvent event) {
                        if (event instanceof RealizeCompleteEvent) {
                            ...
                            trackWindow.setTrackLength(((Double)((Player)event.getSource()).getDuration().getSeconds()).intValue());
     ...
     *
     * @param instance la nuova graphicInstance che indica la pagina corrente della partitura
     */
 /*   public void setCurrentGraphicInstance(MXData.GraphicInstanceGroup.GraphicInstance instance) {
        this.currentGraphicInstance=instance;
    }
 */   
    /**
     * Individua e setta la variabile d'istanza "currentGraphicInstance"
     *  comprendendo in quale pagina della partitura ci troviamo in base al punto
     *  di esecuzione del brano
     *
     * @param time punto di esecuzione del brano correntem, in centesimi di secondo
     */
 /*   public void setCurrentGraphicInstance(int time) {
        MXData.GraphicInstanceGroup group=this.MX.graphic_instance_group.get((String)this.partitureCombo.getSelectedItem());
        
        if (time==0) this.currentGraphicInstance=group.instances.get(0);
        else {
            for(int i=0;i<group.instances.size();i++) {
                if (this.currentAudioClip.spine2time.get(group.instances.get(i).spineEnd)>time) {
                    this.currentGraphicInstance=group.instances.get(i);
                    break;
                }
            }
        }
...
//        trackToggleBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mainFrame/Resources/player.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(partitureToggleBtn, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 100, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(voicesToggleBtn, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 69, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(trackToggleBtn, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 109, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.linkSize(new java.awt.Component[] {trackToggleBtn, voicesToggleBtn}, org.jdesktop.layout.GroupLayout.HORIZONTAL);
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                        ...
                        .add(trackToggleBtn, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(audioCombo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jLabel1))
                .addContainerGap())
        );
    ...
    private void trackSliderMouseSomeHowPressed(java.awt.event.MouseEvent evt){
        ...
        /*
         XXX il metodo che segue fa la stessa cosa dell'albero rb ... l'ho scoperto dopo
        java.util.List<Integer> test=Arrays.asList(this.currentAudioClip.time2spine.keySet().toArray(new Integer[0]));
        Collections.sort(test);
        int idx=Collections.binarySearch(test,media_time);
         
        if (idx<0) {
            media_time=test.get(-idx);
        }
         */
    ...
    */
    ...
    public void playerStart(boolean is_starting) {
        if (is_starting) {
            ...
            this.player.stop();
            this.timer.stop();
            //XXX per quale motivo lo facciamo? stop non azzera il tempo del media, da api (credo - CONTROLLARE)
            //oppure e' per correggere l'errore di stop che generea setmute? (non sarebbe irrisorio? )
